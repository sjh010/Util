...
public class DbcpDataSourceFactory {
    ...
    private BasicDataSource createDbcp2DataSource() {
        ...
        try {
            ...
            throw new RpaViewException(RpaViewError.INTERNAL_SERVER_ERROR, "[createDbcp2DataSource exception]");
        }
        return dataSource;
    }
    ...
    private Properties getDbcpProperties() {
        ...
        try {
            ...
            throw new RpaViewException(RpaViewError.INTERNAL_SERVER_ERROR, "[getDbcpProperties exception]");
        }
        return properties;
    }
